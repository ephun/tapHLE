...
pub const SUBSTITUTIONS: &[Substitution] = &[
    ...
    Substitution {
        ...
        note: "Liberation Sans was drawn to Arial's metrics.",
    },
    Substitution {
        ...
        closeness: Closeness::Metric,
        note: "Liberation Serif was drawn to Times New Roman's metrics.",
    },
    Substitution {
        ...
        closeness: Closeness::Metric,
        note: "Liberation Mono was drawn to Courier New's metrics.",
    },
    Substitution {
        ios_family: "Georgia",
        aliases: &[],
        bundled: "gelasio",
        closeness: Closeness::Metric,
        note: "Gelasio was drawn to Georgia's metrics.",
    },
    ...
    Substitution {
        ...
        bundled: "liberation-sans",
        closeness: Closeness::Metric,
        note: "Arial was drawn to Helvetica's metrics and Liberation Sans to \
               Arial's, so text still fits. Inter looks closer.",
    },
    Substitution {
    ...
    Substitution {
        ...
        note: "A condensed grotesque in the same role. Condensed is part of                the family's identity, not a style of Helvetica Neue, so it                resolves separately.",
    },
    Substitution {
        ios_family: "Courier",
        aliases: &[],
        bundled: "liberation-mono",
        closeness: Closeness::Metric,
        note: "Courier New's metrics, which Courier shares closely.",
    },
    Substitution {
        ios_family: "Verdana",
        aliases: &[],
        ...
        note: "Wider than Liberation Sans; expect text to take less room.",
    },
    Substitution {
        ...
        bundled: "liberation-sans",
        closeness: Closeness::Shape,
        note: "A humanist face standing in for a humanist face.",
    },
    ...
    Substitution {
        ...
        bundled: "inter",
        closeness: Closeness::Shape,
        note: "Inter is the closest open face to San Francisco.",
    },
    Substitution {
        ios_family: "Avenir",
        aliases: &[],
        bundled: "inter",
        closeness: Closeness::Role,
        note: "No open Avenir exists; Inter fills the same interface role.",
    },
    Substitution {
    ...
    Substitution {
        ...
        bundled: "barlow-condensed",
        closeness: Closeness::Role,
        note: "A condensed grotesque for a condensed geometric.",
    },
    ...
    Substitution {
        ...
        closeness: Closeness::Shape,
        note: "A Baskerville revival drawn for screens, so it runs wider.",
    },
    Substitution {
        ...
        bundled: "charis-sil",
        closeness: Closeness::Role,
        note: "An old-style text serif in the same role.",
    },
    Substitution {
    ...
    Substitution {
        ...
        bundled: "charis-sil",
        closeness: Closeness::Role,
        note: "A reading serif in the same role.",
    },
    Substitution {
        ios_family: "Palatino",
        aliases: &[],
        bundled: "charis-sil",
        closeness: Closeness::Role,
        note: "A humanist book serif in the same role.",
    },
    Substitution {
        ios_family: "Cochin",
        aliases: &[],
        bundled: "libre-baskerville",
        closeness: Closeness::Role,
        note: "An old-style display serif in the same role.",
    },
    Substitution {
        ios_family: "Didot",
        aliases: &[],
        bundled: "libre-baskerville",
        closeness: Closeness::Role,
        note: "Not a Didone; the contrast is much lower.",
    },
    Substitution {
    ...
    Substitution {
        ...
        bundled: "besley",
        closeness: Closeness::Shape,
        note: "Besley is an open Clarendon.",
    },
    Substitution {
        ...
        bundled: "cutive",
        closeness: Closeness::Role,
        note: "A typewriter slab in the same role.",
    },
    ...
    Substitution {
        ...
        bundled: "jost",
        closeness: Closeness::Shape,
        note: "Jost is drawn after the same 1920s geometric sans.",
    },
    Substitution {
        ...
        bundled: "barlow",
        closeness: Closeness::Role,
        note: "A humanist sans in the same role; Gill's letterforms differ.",
    },
    Substitution {
        ios_family: "Optima",
        aliases: &[],
        bundled: "barlow",
        closeness: Closeness::Role,
        note: "Optima's flared stems have no open equivalent.",
    },
    Substitution {
        ...
        bundled: "barlow",
        closeness: Closeness::Role,
        note: "An industrial grotesque in the same role.",
    },
    Substitution {
        ...
        bundled: "barlow-condensed",
        closeness: Closeness::Role,
        note: "A condensed industrial grotesque in the same role.",
    },
    Substitution {
        ...
        closeness: Closeness::Role,
        note: "A rounded sans in the same role; only one weight.",
    },
    Substitution {
        ...
        bundled: "cinzel",
        closeness: Closeness::Role,
        note: "An inscriptional capital face in the same role.",
    },
    Substitution {
        ...
        closeness: Closeness::Role,
        note: "A decorative engraved face in the same role.",
    },
    ...
    Substitution {
        ...
        closeness: Closeness::Role,
        note: "A handwriting face in the same role.",
    },
    Substitution {
    ...
    Substitution {
        ...
        bundled: "kalam",
        closeness: Closeness::Role,
        note: "A handwriting face in the same role, with a bold.",
    },
    Substitution {
        ...
        bundled: "comic-neue",
        closeness: Closeness::Role,
        note: "An informal sans in the same role.",
    },
    Substitution {
    ...
    Substitution {
        ...
        bundled: "allura",
        closeness: Closeness::Role,
        note: "A formal script in the same role. Word widths differ a lot.",
    },
    Substitution {
        ...
        bundled: "alex-brush",
        closeness: Closeness::Role,
        note: "A brush script in the same role. Word widths differ a lot.",
    },
    Substitution {
        ios_family: "Zapfino",
        aliases: &[],
        bundled: "tangerine",
        closeness: Closeness::Role,
        note: "Nothing open is close to Zapfino. This is a calligraphic face, \
    ...
    Substitution {
        ...
        bundled: "almendra",
        closeness: Closeness::Role,
        note: "Nothing open is close to Papyrus. This is a historic-hand face.",
    },
    Substitution {
        ...
        bundled: "lobster",
        closeness: Closeness::Role,
        note: "Nothing open is close to Party LET. This is a display face.",
    },
    ...
    Substitution {
        ...
        closeness: Closeness::Role,
        note: "Symbols by Unicode meaning, not by Symbol's old code points.",
    },
    Substitution {
        ...
        bundled: "noto-sans-symbols-2",
        closeness: Closeness::Role,
        note: "Symbols by Unicode meaning, not by the old code points.",
    },
    Substitution {
        ...
        closeness: Closeness::Role,
        note: "A Japanese gothic in the same role.",
    },
    Substitution {
        ...
        bundled: "noto-sans-jp",
        closeness: Closeness::Role,
        note: "A gothic standing in for a mincho: the serifs are missing.",
    },
];
