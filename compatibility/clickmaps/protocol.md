...
- `compatibility/clickmaps/schema.json` — the format, JSON Schema 2020-12.
- `compatibility/clickmaps/<slug>.json` — one map per app, slug matching the app
  note in `compatibility/notes/`.
...
`docs/debugging.md` warns about — a screen that animates on
