...
- `compatibility/clickmaps/crafted.json` replayed end to end on a fresh profile —
...
of `compatibility/clickmaps/crafted.json`, behind `-HasSaveState`.
...
The route is recorded as `compatibility/clickmaps/crafted.json` and was replayed end
